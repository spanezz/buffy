#ifndef BUFFY_UTILS_TESTSRUNNER_H
#define BUFFY_UTILS_TESTSRUNNER_H
...
struct SimpleTestController : public FilteringTestController
{
    ...
    SimpleTestController(buffy::utils::term::Terminal& output);
...
struct VerboseTestController : public FilteringTestController
{
    ...
    VerboseTestController(buffy::utils::term::Terminal& output);
...
struct TestResultStats
{
    ...
    void print_results(buffy::utils::term::Terminal& out);
    void print_stats(buffy::utils::term::Terminal& out);
    void print_summary(buffy::utils::term::Terminal& out);
};
