...
SimpleTestController::SimpleTestController(buffy::utils::term::Terminal& output)
    : output(output)
{
}
...
VerboseTestController::VerboseTestController(buffy::utils::term::Terminal& output)
    : output(output) {}
...
struct Title
{
    buffy::utils::term::Terminal& output;
    std::string title;
    bool printed = false;

    Title(buffy::utils::term::Terminal& output, const std::string& title)
...
void TestResultStats::print_results(buffy::utils::term::Terminal& out)
{
...
void TestResultStats::print_stats(buffy::utils::term::Terminal& out)
{
...
void TestResultStats::print_summary(buffy::utils::term::Terminal& out)
{
